...
<body>
    ...
    <div class="container">
        ...
        <form action="<?= base_url('proses_add_desa') ?>" method="POST">
            <!-- <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <select id="provinsi" name="id_provinsi" class="form-select" required aria-label="select example">
                    ...
                    <?php foreach ($all_data_provinsi as $provinsi) : ?>
                        <?php
                        $selected = (isset($_POST['provinsi']) && $provinsi->id_provinsi == $_POST['provinsi']) ? 'selected' : '';
                        ?>
                        <option value="<?= $provinsi->id_provinsi ?>" <?= $selected ?>><?= $provinsi->provinsi ?></option>
                    <?php endforeach; ?>
                </select>
            </div>
            ...
            <div class="mb-3">
                ...
                <select id="kecamatan" name="id_kecamatan" class="form-select" required aria-label="select example" disabled>
                    <option value="">Pilih Kecamatan</option>
                </select>
            </div>

            <div class="mb-3">
                <label for="exampleFormControlInput1" class="form-label" class="text-primary">Desa</label>
                <input type="text" class="form-control" id="id_desa" name="desa">
            </div>
            ...
            <div>
                <a href="<?= base_url('desa') ?>" class="btn btn-primary bi bi-skip-backward"> Back To List</a>
            </div>
        </form>
    </div>
    <!-- FOOTER CONTENT -->
